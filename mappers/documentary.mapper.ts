...
import { Documentary } from '../entities/media.entity.js';
 ...
 */
export function mapDocumentaryDTOToEntity(dto: Partial<DocumentaryDTO>, lang: 'es' | 'en' = 'es'): Documentary {
    const isEn = lang === 'en';
...
export function mapDocumentaryDTOArrayToEntities(dtos: Partial<DocumentaryDTO>[], lang: 'es' | 'en' = 'es'): Documentary[] {
