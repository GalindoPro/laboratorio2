...
import { Movie } from '../entities/media.entity.js';
 ...
 */
export function mapMovieDTOToEntity(dto: Partial<MovieDTO>, lang: 'es' | 'en' = 'es'): Movie {
    const isEn = lang === 'en';
 ...
 */
export function mapMovieDTOArrayToEntities(dtos: Partial<MovieDTO>[], lang: 'es' | 'en' = 'es'): Movie[] {
